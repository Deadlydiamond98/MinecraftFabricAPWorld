...
def create_create_itemsanity_regions(world: FabricMinecraftWorld):
    ...
    create_region(world, "Menu", "Cutting", {
        ...
        "Cut Granite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Granite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Granite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Granite (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Granite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Granite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Granite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Granite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Granite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Granite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Granite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Granite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Granite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Granite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Granite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Diorite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Diorite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Diorite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Diorite (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Diorite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Diorite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Diorite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Diorite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Diorite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Diorite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Diorite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Diorite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Diorite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Diorite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Diorite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Andesite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Andesite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Andesite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Andesite (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Andesite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Andesite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Andesite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Andesite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Andesite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Andesite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Andesite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Andesite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Andesite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Andesite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Andesite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Calcite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Calcite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Calcite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Calcite (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Calcite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Calcite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Calcite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Calcite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Calcite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Calcite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Calcite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Calcite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Calcite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Calcite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Calcite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Dripstone Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Dripstone Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Dripstone Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Dripstone (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Dripstone Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Dripstone Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Dripstone Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Dripstone Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Dripstone Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Dripstone Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Dripstone Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Dripstone Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Dripstone Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Dripstone Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Dripstone Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Deepslate Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Deepslate Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Deepslate Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Deepslate (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Deepslate Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Deepslate Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Deepslate Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Deepslate Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Deepslate Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Deepslate Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Deepslate Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Deepslate Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Deepslate Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Deepslate Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Deepslate Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Tuff Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Tuff Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Tuff Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Tuff (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Tuff Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Tuff Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Tuff Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Tuff Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Tuff Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Tuff Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Tuff Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Tuff Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Tuff Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Tuff Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Tuff Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Asurine Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Asurine Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Asurine Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Asurine (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Asurine Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Asurine Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Asurine Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Asurine Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Asurine Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Asurine Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Asurine Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Asurine Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Asurine Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Asurine Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Asurine Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Crimsite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Crimsite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Crimsite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Crimsite (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Crimsite Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Crimsite Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Crimsite Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Crimsite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Crimsite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Crimsite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Crimsite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Crimsite Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Crimsite Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Crimsite Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Crimsite Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Limestone Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Limestone Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Limestone Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Limestone (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Limestone Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Limestone Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Limestone Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Limestone Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Limestone Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Limestone Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Limestone Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Limestone Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Limestone Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Limestone Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Limestone Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Ochrum Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Ochrum Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Ochrum Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Ochrum (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Ochrum Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Ochrum Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Ochrum Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Ochrum Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Ochrum Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Ochrum Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Ochrum Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Ochrum Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Ochrum Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Ochrum Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Ochrum Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Veridium Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Veridium Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Veridium Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Veridium (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Veridium Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Veridium Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Veridium Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Veridium Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Veridium Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Veridium Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Veridium Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Veridium Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Veridium Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Veridium Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Veridium Brick Wall (Itemsanity) {Create}": ITEMSANITY,
    ...
    create_region(world, "CanSmelt", "SmeltAndCutting", {
        ...
        "Copper Shingle Slab (Itemsanity) {Create}": ITEMSANITY,
        "Exposed Copper Shingle Slab (Itemsanity) {Create}": ITEMSANITY,
        "Weathered Copper Shingle Slab (Itemsanity) {Create}": ITEMSANITY,
        "Oxidized Copper Shingle Slab (Itemsanity) {Create}": ITEMSANITY,
        "Copper Shingle Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Exposed Copper Shingle Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Weathered Copper Shingle Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Oxidized Copper Shingle Stairs (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Waxed Copper Shingle Slab (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Exposed Copper Shingle Slab (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Weathered Copper Shingle Slab (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Oxidized Copper Shingle Slab (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Copper Shingle Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Exposed Copper Shingle Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Weathered Copper Shingle Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Oxidized Copper Shingle Stairs (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Copper Tile Slab (Itemsanity) {Create}": ITEMSANITY,
        "Exposed Copper Tile Slab (Itemsanity) {Create}": ITEMSANITY,
        "Weathered Copper Tile Slab (Itemsanity) {Create}": ITEMSANITY,
        "Oxidized Copper Tile Slab (Itemsanity) {Create}": ITEMSANITY,
        "Copper Tile Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Exposed Copper Tile Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Weathered Copper Tile Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Oxidized Copper Tile Stairs (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Waxed Copper Tile Slab (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Exposed Copper Tile Slab (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Weathered Copper Tile Slab (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Oxidized Copper Tile Slab (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Copper Tile Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Exposed Copper Tile Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Weathered Copper Tile Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Waxed Oxidized Copper Tile Stairs (Itemsanity) {Create}": ITEMSANITY,
    ...
    create_region(world, "NetherAccess", "NetherAccessAndCutting", {
        ...
        "Cut Scoria Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scoria Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scoria Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Scoria (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Scoria Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Scoria Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Scoria Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scoria Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scoria Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scoria Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scoria Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Scoria Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Scoria Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Scoria Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Scoria Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        ...
        "Cut Scorchia Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scorchia Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scorchia Wall (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Scorchia (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Scorchia Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Scorchia Slab (Itemsanity) {Create}": ITEMSANITY,
        "Polished Cut Scorchia Wall (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scorchia Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scorchia Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scorchia Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Cut Scorchia Brick Wall (Itemsanity) {Create}": ITEMSANITY,
        "Small Scorchia Bricks (Itemsanity) {Create}": ITEMSANITY,
        "Small Scorchia Brick Stairs (Itemsanity) {Create}": ITEMSANITY,
        "Small Scorchia Brick Slab (Itemsanity) {Create}": ITEMSANITY,
        "Small Scorchia Brick Wall (Itemsanity) {Create}": ITEMSANITY,
